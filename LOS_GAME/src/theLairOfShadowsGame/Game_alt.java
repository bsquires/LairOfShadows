	...
	*/
	...
	public void desertZone() throws IOException{
		if (subzone1){
			...
			ImageIcon img=new ImageIcon(getClass().getResource("/resources/mountains.jpg"));
			gImage=img.getImage();
			...
			gText.setText("");
			fStream=getClass().getResourceAsStream("/resources/Lair of Shadows DesertBossZone Mountains.txt");
			inStream = new InputStreamReader(fStream);
			fReader=new BufferedReader(inStream);
			while((readFile = fReader.readLine() ) != null){
				gText.append(readFile);
			...
			fStream=getClass().getResourceAsStream("/resources/Lair of Shadows Story Enemy Warrior Cerberus.txt");
			inStream = new InputStreamReader(fStream);
			fReader=new BufferedReader(inStream);
			while((readFile = fReader.readLine() ) != null){
				gText.append(readFile);
	...
	public void forestZone() throws IOException{
		if (subzone1){
			...
			ImageIcon img=new ImageIcon(getClass().getResource("/resources/forest_clearing.jpg"));
			gImage=img.getImage();
			...
			gText.append("\n"+"\n");
			fStream=getClass().getResourceAsStream("/resources/Lair of Shadows ForestSubZone Open Clearing.txt");
			inStream = new InputStreamReader(fStream);
			fReader=new BufferedReader(inStream);
			while((readFile = fReader.readLine() ) != null){
				gText.append(readFile);
			...
			ImageIcon img=new ImageIcon(getClass().getResource("/resources/forest_cliff.jpg"));
			gImage=img.getImage();
			...
			gText.setText("");
			gText.append("\n"+"\n");
			fStream=getClass().getResourceAsStream("/resources/Lair of Shadows ForestSubZone Cliff.txt");
			inStream = new InputStreamReader(fStream);
			fReader=new BufferedReader(inStream);
			while((readFile = fReader.readLine() ) != null){
				gText.append(readFile);
			...
			ImageIcon img=new ImageIcon(getClass().getResource("/resources/hollow_tree.jpg"));
			gImage=img.getImage();
			...
			gText.setText("");
			fStream=getClass().getResourceAsStream("/resources/Lair of Shadows ForestBossZone Hollow Tree.txt");
			inStream = new InputStreamReader(fStream);
			fReader=new BufferedReader(inStream);
			while((readFile = fReader.readLine() ) != null){
				gText.append(readFile);
			...
			fStream=getClass().getResourceAsStream("/resources/Lair of Shadows Story Enemy Rogue Hermes.txt");
			inStream = new InputStreamReader(fStream);
			fReader=new BufferedReader(inStream);
			while((readFile = fReader.readLine() ) != null){
				gText.append(readFile);
	...
	public void swampZone() throws IOException{
		...
		ImageIcon img=new ImageIcon(getClass().getResource("/resources/swamp_lake.jpg"));
		gImage=img.getImage();
		...
		if (subzone1){
			gText.append("\n"+"\n");
			fStream=getClass().getResourceAsStream("/resources/Lair of Shadows SwampSubZone Lake.txt");
			inStream = new InputStreamReader(fStream);
			fReader=new BufferedReader(inStream);
			while((readFile = fReader.readLine() ) != null){
				gText.append(readFile);
			...
			img=new ImageIcon(getClass().getResource("/resources/swamp_dry_patch.jpg"));
			gImage=img.getImage();
			...
			gText.setText("");
			fStream=getClass().getResourceAsStream("/resources/Lair of Shadows SwampSubZone Dry Patch.txt");
			inStream = new InputStreamReader(fStream);
			fReader=new BufferedReader(inStream);
			while((readFile = fReader.readLine() ) != null){
				gText.append(readFile);
			...
			img=new ImageIcon(getClass().getResource("/resources/swamp_vine_mass.jpg"));
			gImage=img.getImage();
			...
			gText.setText("");
			fStream=getClass().getResourceAsStream("/resources/Lair of Shadows SwampBossZone Vine Covered Mass.txt");
			inStream = new InputStreamReader(fStream);
			fReader=new BufferedReader(inStream);
			while((readFile = fReader.readLine() ) != null){
				gText.append(readFile);
			...
			fStream=getClass().getResourceAsStream("/resources/Lair of Shadows Story Enemy Mage Medusa.txt");
			inStream = new InputStreamReader(fStream);
			fReader=new BufferedReader(inStream);
			while((readFile = fReader.readLine() ) != null){
				gText.append(readFile);
	...
	public void createDesertSubBoss(){
		...
		ImageIcon img=new ImageIcon(getClass().getResource("/resources/cerberus.jpg"));
		gImage=img.getImage();
	...
	public void createForestSubBoss(){
		...
		ImageIcon img=new ImageIcon(getClass().getResource("/resources/hermes.jpg"));
		gImage=img.getImage();
	...
	public void createSwampSubBoss(){
		...
		ImageIcon img=new ImageIcon(getClass().getResource("/resources/medusa.jpg"));
		gImage=img.getImage();
	...
	public void createFinalBoss(){
		...
		ImageIcon img=new ImageIcon(getClass().getResource("/resources/mastermind.jpg"));
		gImage=img.getImage();
	...
	class dirListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			if (cChoice.equals("Desert")) {
				gText.setText("");
				fStream=getClass().getResourceAsStream("/resources/Lair of Shadows Story Desert.txt");
				inStream = new InputStreamReader(fStream);
				fReader=new BufferedReader(inStream);
				try {
					while((readFile = fReader.readLine() ) != null){
					...
					System.out.println("ERROR IN dirListener");
				}
				...
				gText.setText("");
				fStream=getClass().getResourceAsStream("/resources/Lair of Shadows Story Forest.txt");
				inStream = new InputStreamReader(fStream);
				fReader=new BufferedReader(inStream);
				try {
					while((readFile = fReader.readLine() ) != null){
				...
				gText.setText("");
				fStream=getClass().getResourceAsStream("/resources/Lair of Shadows Story Swamp.txt");
				inStream = new InputStreamReader(fStream);
				fReader=new BufferedReader(inStream);
				try {
					while((readFile = fReader.readLine() ) != null){
